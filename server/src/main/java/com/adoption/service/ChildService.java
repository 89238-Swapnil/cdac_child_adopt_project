...
public class ChildService {
    ...
    public Child updateChild(Long userId, Long childId, Child updatedChild) {
        ...
        if (updatedChild.getDateOfBirth() != null) {
            child.setDateOfBirth(updatedChild.getDateOfBirth());
        }
        if (updatedChild.getAdmissionDate() != null) {
        ...
        if (updatedChild.getIsAvailable() != null) {
            child.setIsAvailable(updatedChild.getIsAvailable());
        }
